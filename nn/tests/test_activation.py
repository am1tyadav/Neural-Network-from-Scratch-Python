...
class ActivationTest(unittest.TestCase):
    ...
    def test_sigmoid(self):
        ...
        # Checking values
        self.assertAlmostEqual(float(sigmoid(_input)[0]), 0.)
        self.assertAlmostEqual(float(sigmoid(_input)[1]), 0.5)
        self.assertAlmostEqual(float(sigmoid(_input)[2]), 1.)
        self.assertAlmostEqual(float(sigmoid.gradient(_input)[0]), 0.)
        self.assertAlmostEqual(float(sigmoid.gradient(_input)[2]), 0.)
